...
export const books: Book[] = [
  ...
  { title: 'Gunahon Ka Devta (गुनाहों का देवता)', spineTitle: 'Gunahon Ka Dev', spineAuthor: 'DB', author: 'Dharamvir Bharati', year: 1949, category: 'Fiction', spineColor: '#a03125', spineInk: '#f7f4ed', url: 'https://en.wikipedia.org/wiki/Gunahon_Ka_Devta_(novel)' },
  { title: 'Musafir Cafe', spineTitle: 'Musafir Cafe', spineAuthor: 'DPD', author: 'Divya Prakash Dubey', year: 2016, category: 'Fiction', spineColor: '#2d5a27', spineInk: '#f7f4ed', url: 'https://www.goodreads.com/book/show/32014498-musafir-cafe' },
  ...
  { title: 'October Junction', spineTitle: 'October Junctio', spineAuthor: 'DPD', author: 'Divya Prakash Dubey', year: 2018, category: 'Fiction', spineColor: '#d26a27', spineInk: '#171717', url: 'https://www.goodreads.com/en/book/show/42296767' },
  { title: 'Deewar Mein Ek Khirkee Rahati Thi', spineTitle: 'Deewar Mein', spineAuthor: 'VKS', author: 'Vinod Kumar Shukla', year: 1997, category: 'Fiction', spineColor: '#1d3e53', spineInk: '#f7f4ed', url: 'https://en.wikipedia.org/wiki/Deewar_Mein_Ek_Khirkee_Rahati_Thi' },
  ...
  { title: 'Ret Ki Machhali', spineTitle: 'Ret Ki Machhali', spineAuthor: 'KB', author: 'Kanta Bharti', year: 1968, category: 'Fiction', spineColor: '#cfad6c', spineInk: '#171717', url: '#' },
