...
export const books: Book[] = [
  ...
  { title: 'Gunahon Ka Devta (गुनाहों का देवता)', spineTitle: 'Gunahon Ka Dev', spineAuthor: 'DB', author: 'Dharamvir Bharati', year: 1949, category: 'Fiction', spineColor: '#bda48c', spineInk: '#171717', art: '/images/books/dharamvir-bharati-gunahon-ka-devta-v2.jpg', coverWidth: 572, coverHeight: 900, spine: 24, url: 'https://en.wikipedia.org/wiki/Gunahon_Ka_Devta_(novel)' },
