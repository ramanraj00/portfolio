...
export const books: Book[] = [
  ...
  { title: 'Deewar Mein Ek Khirkee Rahati Thi', spineTitle: 'Deewar Mein', spineAuthor: 'VKS', author: 'Vinod Kumar Shukla', year: 1997, category: 'Fiction', spineColor: '#2c5863', spineInk: '#f7f4ed', art: '/images/books/vinod-kumar-shukla-deewar-mein-ek-khirkee-rahati-thi-v2.jpg', coverWidth: 574, coverHeight: 876, spine: 24, url: 'https://en.wikipedia.org/wiki/Deewar_Mein_Ek_Khirkee_Rahati_Thi' },
