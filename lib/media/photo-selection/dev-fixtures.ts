...
<text x="${inset}" y="${inset * 2.4}" fill="${ink}" fill-opacity="0.6" font-family="ui-monospace, monospace" font-size="${Math.min(width, height) * 0.035}" letter-spacing="4">RAMAN TEST CARD ${number} — ${width}×${height}</text>
</svg>`
